...
function pbmt_scroller_portfolio() {
    if (!$('.pbmit-element-portfolio-style-3, .pbmit-element-portfolio-style-12').length) {
        return;
    }
    ...
    ScrollTrigger.matchMedia({
        "(min-width:1200px)": function() {
            ...
            gsap.set(".pbmit-element-portfolio-style-3 .pbminfotech-img-wrapper, .pbmit-element-portfolio-style-12 .pbminfotech-img-wrapper", {
            ...
            gsap.set(".pbmit-element-portfolio-style-3, .pbmit-element-portfolio-style-12", {
...
function pbmit_staticbox_hover() {
    var pbmit_var = $('.pbmit-element-static-box-style-1, .pbmit-element-static-box-style-3, .pbmit-element-static-box-style-2, .pbmit-element-service-style-7, .pbmit-element-service-style-3, .pbmit-element-service-style-12');
    if (!pbmit_var.length) {
        return;
    }
    ...
    ScrollTrigger.matchMedia({
        "(min-width: 768px)": function() {
            pbmit_elm.forEach((box, i) => {
                ...
                tl.fromTo(box.querySelector(".pbmit-action-box-circle-wrap"), {
...
function pbmit_sticky_menu() {
    if (!$(".pbmit-element-restaurant-menu-style-1")[0]) {
        return
    }
    ScrollTrigger.matchMedia({
        "(min-width: 992px)": function() {

            let container = $(".pbmit-element-restaurant-menu-style-1 .pbmit-img");
            let section = $(".pbmit-element-restaurant-menu-style-1 .pbmit-element-restaurant-menu-wrapper");
...
function pbmit_team_mask_animation() {
    $(".pbmit-element-team-style-8").append("<div class='pbmit-team-cursor-mask'><div class='pbmit-team-cursor'></div></div>");
    const pbmit_class = document.querySelector('.pbmit-element-team-style-8');

    var pbmit_var = $('.pbmit-element-team-style-8');
    if (!pbmit_var.length) {
        return;
    }
